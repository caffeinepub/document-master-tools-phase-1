    ...
    <>
      ...
      <main className="py-8 md:py-12">
        <div className="container mx-auto px-4">
          <div className="lg:grid lg:grid-cols-[1fr_200px] lg:gap-8">
            <div className="max-w-4xl">
              ...
              <article>
                ...
                <CrossCategorySuggestions currentCategory="calculator" onNavigate={(page) => window.history.back()} />
              </article>
            </div>
          ...
          <ToolCategories onNavigate={(page) => window.history.back()} activeCategory="calculator" />
        </div>
      </main>
    </>
  );
