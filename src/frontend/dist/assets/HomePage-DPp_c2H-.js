import { c as createLucideIcon, r as reactExports, u as useLanguage, j as jsxRuntimeExports } from "./index-YN_OslaE.js";
...
import { F as Flame } from "./flame-CGM_MQ0K.js";
import { S as Shield, L as Layers, a as Scissors, F as FileImage, C as Camera } from "./shield-DBB-rm_m.js";
import { Z as Zap } from "./zap-BXuwvbGj.js";
import { A as Award } from "./award-BEUMcfqP.js";
import { C as Clock } from "./clock-lff9-uE1.js";
import { B as BookOpen, F as FileOutput, P as Palette } from "./palette-CV-vThoQ.js";
import { D as DollarSign, H as Heart } from "./heart-DidR1QO8.js";
import { M as Minimize2 } from "./minimize-2-Tl0OwmCy.js";
import { R as RotateCcw } from "./rotate-ccw-Be4mGQ6U.js";
import { U as UserCheck, B as Briefcase, M as Maximize2, S as ScanLine } from "./user-check-DaNaryTM.js";
import { G as GraduationCap } from "./graduation-cap-sTrPT3TB.js";
import { W as WandSparkles } from "./wand-sparkles-Bf6sSbHf.js";
/**
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white py-16 md:py-24", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-6xl mx-auto px-4 text-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-3xl md:text-5xl font-bold mb-4 text-white", children: [
          t("home.hero.heading"),
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-orange-400", children: t("home.hero.brand") })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg md:text-xl text-slate-300 mb-8 max-w-3xl mx-auto", children: t("home.hero.tagline") }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-12 md:py-16 bg-slate-800", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl md:text-3xl font-bold text-white mb-3", children: t("home.calculatorHub.title") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-300 max-w-2xl mx-auto", children: t("home.calculatorHub.description") })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-12 md:py-16 bg-slate-900", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl md:text-3xl font-bold text-white mb-3", children: t("home.pdfTools.title") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-300 max-w-2xl mx-auto", children: t("home.pdfTools.description") })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-12 md:py-16 bg-slate-800", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl md:text-3xl font-bold text-white mb-3", children: t("home.imageTools.title") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-300 max-w-2xl mx-auto", children: t("home.imageTools.description") })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-12 md:py-16 bg-slate-900", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl md:text-3xl font-bold text-white mb-3", children: t("home.resumeBuilder.title") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-300 max-w-2xl mx-auto", children: t("home.resumeBuilder.description") })
      ] }),
