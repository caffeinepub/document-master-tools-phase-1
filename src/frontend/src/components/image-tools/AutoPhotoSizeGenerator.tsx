...
export default function AutoPhotoSizeGenerator({
  uploadedFile,
  onProcessed,
  onProcessingStart,
}: Props) {
  ...
  const handleProcess = useCallback(async () => {
    const w = Number.parseInt(targetWidth);
    const h = Number.parseInt(targetHeight);
    const kb = Number.parseInt(targetKB);
    if (!w || !h || !kb) return;
