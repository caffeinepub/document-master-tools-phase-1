...
export default function ExportOptionsPanel({
  ...
  const freeActions = [
    ...
    },
    {
      ...
      onClick: downloadPNG,
      color:
        "bg-blue-500/10 border-blue-500/30 hover:bg-blue-500/20 text-blue-700 dark:text-blue-400",
      isPro: false,
    },
  ];
  ...
  const proActions = [
    ...
    },
    {
      ...
      color:
        "bg-green-500/10 border-green-500/30 hover:bg-green-500/20 text-green-700 dark:text-green-400",
      isPro: true,
    },
  ];
