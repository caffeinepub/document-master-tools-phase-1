...
import { ArrowLeft, Download, FileImage, X } from "lucide-react";
...
export default function PDFToJPGTool({ onBack }: PDFToJPGToolProps) {
  ...
  const convertToJPG = async () => {
    ...
    try {
      ...
      toast.success(
        `Converted ${totalPages} page${totalPages > 1 ? "s" : ""} to JPG!`,
      );
    } catch (err) {
      const msg =
  ...
  const downloadPage = (page: ConvertedPage) => {
    ...
    a.href = page.dataUrl;
    a.download = `${file?.name?.replace(".pdf", "") || "page"}-page-${page.pageNumber}.jpg`;
    a.click();
  };
  ...
  return (
    <div className="py-8 md:py-12">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-2xl">PDF to JPG</CardTitle>
            <CardDescription>
              Convert each PDF page to a high-quality JPG image. Download pages
              individually.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
              ...
              <>
                ...
                >
                  ...
                  <input
                    ...
                    className="hidden"
                    data-ocid="pdf_to_jpg.upload_button"
                  />
                </div>
                ...
                {error && (
                  <div
                    ...
                    data-ocid="pdf_to_jpg.error_state"
                  >
                    {error}
                  </div>
                )}
                ...
                {file && (
                  <Button
                    ...
                    className="w-full"
                    size="lg"
                    data-ocid="pdf_to_jpg.primary_button"
                  >
            ...
            {processing && (
              <div
                ...
                data-ocid="pdf_to_jpg.loading_state"
              >
            ...
            {/* Results */}
            {pages.length > 0 && (
              <div className="space-y-4" data-ocid="pdf_to_jpg.success_state">
                  ...
                  <div className="flex gap-2">
                    {pages.length > 1 && (
                      <Button
                        ...
                        size="sm"
                        onClick={downloadAll}
                        data-ocid="pdf_to_jpg.secondary_button"
                      >
                    ...
                    <Button
                      ...
                      size="sm"
                      onClick={reset}
                      data-ocid="pdf_to_jpg.cancel_button"
                    >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {pages.map((page) => (
                    <div
                      ...
                      data-ocid={`pdf_to_jpg.item.${page.pageNumber}`}
                    >
                      <img
                        src={page.dataUrl}
                      ...
                      <div className="p-3 flex items-center justify-between bg-muted/30">
                        ...
                        <Button
                          ...
                          data-ocid={`pdf_to_jpg.download_button.${page.pageNumber}`}
                        >
