      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <p className="text-lg text-muted-foreground">
            Professional calculators for academic, financial, and health needs.
            All calculations are instant and performed in your browser.
          </p>
        </div>
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                8 calculators for students and educators
              </p>
            </div>
          </div>
        ...
        <div className="section-spacing-lg">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                8 calculators for financial planning
              </p>
            </div>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        ...
        <div className="section-spacing-lg">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                4 calculators for health and time
              </p>
            </div>
          </div>
