    ...
    <div className="py-8 md:py-12">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <article className="prose prose-slate dark:prose-invert max-w-none">
          ...
          <p>
            The information provided by Document Master Tools is for general
          ...
          <p>
            The tools and services provided on this website are not intended to
            be a substitute for professional advice. Always seek the advice of
            qualified professionals with any questions you may have regarding
            document processing, legal matters, or business decisions.
          </p>

          <h2>Tool Accuracy</h2>
          <p>
            While we strive to provide accurate and reliable document processing
            tools, we cannot guarantee:
          </p>
          <ul>
            <li>
              Perfect conversion or processing results for all document types
            </li>
            <li>Compatibility with all file formats and versions</li>
            <li>
              Preservation of all formatting, fonts, or special characters
            </li>
            <li>
              100% accuracy in OCR (Optical Character Recognition) results
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>
              Ensuring they have the legal right to process uploaded documents
            </li>
            <li>Backing up important documents before processing</li>
            <li>
              Reviewing output files before using them for official purposes
            </li>
          </ul>
          ...
          <p>
            ...
            Document Master Tools is not responsible for any errors or omissions
            or for the results obtained from the use of this information.
          </p>

          <h2>Fair Use</h2>
          <p>
            This website may use copyrighted material which has not always been
            specifically authorized by the copyright owner. We believe this
          ...
          <h2>No Warranties</h2>
          <p>
            This website and its tools are provided "as is" without any
