...
import CrossCategorySuggestions from "@/components/CrossCategorySuggestions";
              ...
              <article>
                <header className="mb-8">
                  ...
                  <p className="text-lg text-muted-foreground">
                    Calculate exact age in years, months, days from date of
                    birth.
                  </p>
                </header>
                ...
                <section className="mt-8 prose prose-sm max-w-none">
                  ...
                  <p className="text-muted-foreground mb-4">
                    ...
                    your date of birth. Also see your age in total months,
                    weeks, days, and hours. Get a countdown to your next
                    birthday.
                  </p>
                  <p className="text-muted-foreground">
                    Perfect for filling forms, tracking milestones, or just
                    satisfying your curiosity about your exact age.
                  </p>
                </section>

                <RelatedTools tools={relatedTools} category="calculator" />
