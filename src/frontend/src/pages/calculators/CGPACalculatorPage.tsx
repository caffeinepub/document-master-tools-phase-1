        ...
        <article>
          ...
          <section className="mt-8 prose prose-sm max-w-none">
            ...
            <p className="text-muted-foreground mb-4">
              The CGPA (Cumulative Grade Point Average) Calculator helps
              students calculate their overall academic performance across
              multiple semesters. Simply add your semesters, enter the grade
              points and credits for each course, and get instant results.
            </p>
            <p className="text-muted-foreground mb-4">
              CGPA is calculated using the formula: CGPA = Σ(grade points ×
              credits) / Σ(credits). This weighted average gives you an accurate
              representation of your academic standing on a 10.0 scale.
            </p>
            <p className="text-muted-foreground">
              This calculator is perfect for engineering students, university
              students, and anyone tracking their academic progress across
              multiple terms.
            </p>
          </section>
