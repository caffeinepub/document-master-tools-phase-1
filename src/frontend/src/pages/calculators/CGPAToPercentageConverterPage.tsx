...
export default function CGPAToPercentageConverterPage({
  onBack,
}: CGPAToPercentageConverterPageProps) {
  useEffect(() => {
        ...
        <article>
          ...
          <section className="mt-8 prose prose-sm max-w-none">
            <h2 className="text-xl font-semibold mb-3">
              About CGPA to Percentage Conversion
            </h2>
            <p className="text-muted-foreground mb-4">
              Convert your CGPA to percentage using standard formulas. CBSE
              formula (CGPA × 9.5) is commonly used for school education, while
              Engineering formula (CGPA × 10) is used in many technical
              institutions.
            </p>
            <p className="text-muted-foreground">
              Select the appropriate formula based on your institution's
              guidelines to get accurate percentage conversion.
            </p>
          </section>
