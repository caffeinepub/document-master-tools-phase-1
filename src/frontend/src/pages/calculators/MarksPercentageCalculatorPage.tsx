...
export default function MarksPercentageCalculatorPage({
  onBack,
}: MarksPercentageCalculatorPageProps) {
  useEffect(() => {
        ...
        <article>
          ...
          <section className="mt-8 prose prose-sm max-w-none">
            <h2 className="text-xl font-semibold mb-3">
              About Marks Percentage Calculator
            </h2>
            <p className="text-muted-foreground mb-4">
              Calculate your exam percentage by entering obtained marks and
              total marks. The calculator shows your percentage with pass/fail
              indication based on 40% threshold.
            </p>
            <p className="text-muted-foreground">
              Formula: Percentage = (Obtained Marks / Total Marks) × 100.
              Results are displayed with two decimal places for accuracy.
            </p>
          </section>
