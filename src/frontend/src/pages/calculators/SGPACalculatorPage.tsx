        ...
        <article>
          <header className="mb-8">
            ...
            <p className="text-lg text-muted-foreground">
              Calculate your Semester Grade Point Average with course-wise grade
              input.
            </p>
          </header>
          ...
          <section className="mt-8 prose prose-sm max-w-none">
            ...
            <p className="text-muted-foreground mb-4">
              ...
              performance for a single semester. Enter your course grade points
              (0-10 scale) and credit hours to calculate your SGPA instantly.
            </p>
            <p className="text-muted-foreground">
              The calculation uses the weighted average formula: SGPA = Σ(grade
              points × credits) / Σ(credits), giving you accurate results based
              on your course credits.
            </p>
          </section>
