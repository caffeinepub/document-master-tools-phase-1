  ...
  const settingsSlot = (
    <div className="space-y-5">
      ...
      <div className="bg-amber-900/20 border border-amber-700/40 rounded-lg p-3 text-xs text-amber-300">
        <strong>Note:</strong> This tool uses a simple threshold-based
        background removal (removes near-white pixels). For complex backgrounds,
        results may vary.
      </div>
    </div>
  );
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400">
            Remove or replace image backgrounds with transparent, white, custom
            color, or blur options.
          </p>
        </div>
