...
const JPGToPNGPage: React.FC<{ onNavigate?: (page: string) => void }> = ({
  onNavigate,
}) => {
    ...
    async (file: File): Promise<ProcessingResult> => {
      return new Promise((resolve, reject) => {
        ...
        img.onload = async () => {
          ...
          // PNG supports transparency — don't fill background
  ...
  const settingsSlot = (
    <div className="space-y-5">
      <div className="space-y-2">
        ...
        <Select
          value={format}
          onValueChange={(v) => setFormat(v as "png" | "webp")}
        >
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400">
            Convert JPEG images to PNG or WebP format with quality control and
