...
const WEBPConverterPage: React.FC<{ onNavigate?: (page: string) => void }> = ({
  onNavigate,
}) => {
  ...
  const settingsSlot = (
    <div className="space-y-5">
      <div className="space-y-2">
        ...
        <Select
          value={format}
          onValueChange={(v) => setFormat(v as "webp" | "jpeg" | "png")}
        >
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400">
            Convert images to/from WebP format with quality control and
