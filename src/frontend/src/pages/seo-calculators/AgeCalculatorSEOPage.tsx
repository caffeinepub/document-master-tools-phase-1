...
export default function AgeCalculatorSEOPage({ onNavigate, onBack }: Props) {
  ...
  useEffect(() => {
    document.title =
      "Age Calculator Online – Calculate Exact Age | DocMasterTools";
  }, []);
    ...
    >
      ...
      <div style={{ maxWidth: "900px", margin: "0 auto" }}>
        ...
        >
          ...
          <span style={{ margin: "0 0.4rem" }}>›</span>
          <span style={{ color: ACCENT_LIGHT }}>Age Calculator Online</span>
        </nav>
        ...
        >
          Age Calculator Online – Calculate Exact Age from Date of Birth
        </h1>
        <p
          style={{
            ...bodyText,
        ...
        >
          Find your exact age in years, months, days, total weeks, and total
          days. You can also calculate how many days remain until your next
          birthday. Enter your date of birth below — results appear instantly,
          no login needed.
        </p>

        {/* ── TOOL ── */}
        <div style={cardStyle}>
          <h2 style={{ ...h2Style, color: ACCENT_LIGHT }}>Age Calculator</h2>
          ...
          >
            ...
            <div>
              <label style={labelStyle} htmlFor="asOf">
                Calculate Age As On (optional)
              </label>
              <input
                id="asOf"
                data-ocid="agecalc.input"
              ...
              >
                Leave as today or enter a past/future cut-off date
              </p>
            </div>
          </div>
        ...
        {/* ── SEO CONTENT ── */}
        <div style={cardStyle}>
          <h2 style={h2Style}>What Is an Age Calculator?</h2>
          <p style={bodyText}>
            An age calculator is a tool that computes your exact age from your
            date of birth. Unlike simply subtracting birth year from current
            year, a proper age calculator accounts for whether your birthday has
            already occurred this calendar year, and correctly handles months
            with different numbers of days, as well as leap years. The result is
            precise to the year, month, and day.
          </p>
          <p style={{ ...bodyText, marginTop: "0.75rem" }}>
            Age calculations come up in dozens of real-world situations: filling
            government forms, verifying eligibility for exams, calculating
            retirement age, processing insurance applications, tracking child
            development milestones, or simply satisfying curiosity. Manual
            calculation is error-prone, especially around birthdays in January
            or February where the year boundary makes subtraction confusing.
          </p>
          <p style={{ ...bodyText, marginTop: "0.75rem" }}>
            Our free online age calculator goes beyond a simple year count. It
            shows your total age in months, weeks, and days — useful for medical
            contexts, immigration documents, and more. It also counts down the
            number of days until your next birthday. All calculations run
            instantly in your browser with no data sent to any server.
          </p>
        </div>

        <div style={cardStyle}>
          <h2 style={h2Style}>How to Use the Age Calculator</h2>
          <div
        ...
        <div style={cardStyle}>
          <h2 style={h2Style}>Age Calculation Examples</h2>
          <div
            style={{
              display: "grid",
        ...
        <div style={cardStyle}>
          <h2 style={h2Style}>Tips for Age Calculations</h2>
          <ul
            style={{
              listStyle: "none",
              padding: 0,
