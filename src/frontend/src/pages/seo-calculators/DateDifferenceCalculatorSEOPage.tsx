...
function dateDiff(start: Date, end: Date): DiffResult {
...
export default function DateDifferenceCalculatorSEOPage({
  onNavigate,
  onBack,
}: Props) {
  ...
  useEffect(() => {
    document.title =
      "Date Difference Calculator – Days Between Two Dates | DocMasterTools";
  }, []);
    ...
    >
      ...
      <div style={{ maxWidth: "900px", margin: "0 auto" }}>
        ...
        >
          ...
          any two dates. Useful for project deadlines, contract durations, loan
          tenures, and age verification. Enter your start and end dates and
          results appear instantly — no login needed.
        </p>
          ...
          {result && !error && (
            ...
            >
              ...
              >
                ...
                >
                  {result.isNegative
                    ? "End date is before start date — difference is"
                    : "Exact difference"}
                </div>
                <div
                  style={{
        ...
        {/* ── SEO CONTENT ── */}
        <div style={cardStyle}>
          <h2 style={h2Style}>What Is a Date Difference Calculator?</h2>
          <p style={bodyText}>
            A date difference calculator determines the exact span between two
            calendar dates. This is more complex than simple subtraction because
            months have different numbers of days (28, 29, 30, or 31), and you
            need to account for leap years when counting total days. Manual
            calculation is error-prone — particularly for multi-year spans or
            dates close to month boundaries.
          </p>
          <p style={{ ...bodyText, marginTop: "0.75rem" }}>
            The date difference is one of the most commonly needed calculations
            in everyday life. Students use it to calculate time remaining before
            an exam. Lawyers and accountants use it to measure contract
            durations and interest periods. HR professionals calculate employee
            tenure. Project managers track sprints and milestones. Loan officers
            measure repayment periods. Doctors record the duration of medical
            conditions or pregnancies.
          </p>
          <p style={{ ...bodyText, marginTop: "0.75rem" }}>
            Our free tool shows you four levels of granularity: the total number
            of calendar days, total weeks, the difference expressed as years and
            months (like age), and the total full months. All results appear
            instantly in your browser — no server involved, completely private.
          </p>
        </div>

        <div style={cardStyle}>
          <h2 style={h2Style}>How to Use the Date Difference Calculator</h2>
          <div
        ...
        <div style={cardStyle}>
          <h2 style={h2Style}>Date Difference Examples</h2>
          <div
            style={{
              display: "grid",
        ...
        <div style={cardStyle}>
          <h2 style={h2Style}>Tips for Date Difference Calculations</h2>
          <ul
            style={{
              listStyle: "none",
              padding: 0,
