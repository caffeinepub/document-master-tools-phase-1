...
export default function LoanEMICalculatorPage({ onNavigate, onBack }: Props) {
    ...
    >
      ...
      <div style={{ maxWidth: "900px", margin: "0 auto" }}>
        ...
        >
          ...
          <span style={{ margin: "0 0.4rem" }}>›</span>
          <span style={{ color: ACCENT_LIGHT }}>Loan EMI Calculator</span>
        </nav>
        ...
        >
          ...
          repayment for any home loan, car loan, or personal loan. Enter the
          loan amount, annual interest rate, and tenure to get instant results.
          100% free, no signup.
        </p>

        {/* ── TOOL ── */}
        <div style={cardStyle}>
          <h2 style={{ ...h2Style, color: ACCENT_LIGHT }}>EMI Calculator</h2>
          ...
          >
            <div>
              <label style={labelStyle} htmlFor="principal">
                Loan Amount (₹)
              </label>
              <input
                id="principal"
            ...
            <div>
              <label style={labelStyle} htmlFor="annualRate">
            ...
            <div>
              <label style={labelStyle} htmlFor="tenureMonths">
                Tenure (Months)
              </label>
              <input
                id="tenureMonths"
              ...
              >
                Tip: 1 year = 12 months, 5 years = 60 months
              </p>
            </div>
          </div>
        ...
        {/* ── SEO CONTENT ── */}
        <div style={cardStyle}>
          <h2 style={h2Style}>What Is an EMI Calculator?</h2>
          <p style={bodyText}>
            An EMI (Equated Monthly Instalment) calculator helps you determine
            how much you need to pay each month to repay a loan within a chosen
            tenure at a given interest rate. Whether you are planning a home
            loan, a car loan, an education loan, or a personal loan, knowing
            your monthly EMI before you borrow is one of the most important
            steps in personal financial planning.
          </p>
          <p style={{ ...bodyText, marginTop: "0.75rem" }}>
            The EMI amount depends on three factors: the loan principal (amount
            borrowed), the annual interest rate, and the repayment tenure in
            months. Our calculator uses the standard reducing balance formula to
            give you accurate EMI figures, along with the total interest you
            will pay over the life of the loan and the total amount you will
            repay.
          </p>
          <p style={{ ...bodyText, marginTop: "0.75rem" }}>
            Knowing your EMI in advance helps you budget your monthly expenses,
            compare loan offers from multiple banks, decide the optimal tenure
            that balances affordability and total interest cost, and plan
            prepayments to reduce interest burden.
          </p>
        </div>

        <div style={cardStyle}>
          <h2 style={h2Style}>How to Use the Loan EMI Calculator</h2>
          <div
        ...
        <div style={cardStyle}>
          <h2 style={h2Style}>EMI Examples</h2>
          ...
          >
            * Values are approximate, calculated using the reducing balance
            formula.
          </p>
        </div>

        <div style={cardStyle}>
          <h2 style={h2Style}>Tips for Managing Loan EMIs</h2>
          <ul
            style={{
              listStyle: "none",
              padding: 0,
