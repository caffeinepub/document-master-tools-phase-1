...
// ─── Component ────────────────────────────────────────────────────────────────
export default function PANCardPhotoResizePage({ onNavigate, onBack }: Props) {
  useEffect(() => {
    trackPageView({
  ...
  return (
    ...
    >
      ...
      {/* Open Graph meta via head manipulation */}
      {/* JSON-LD Schemas */}
      <script
      ...
      <div style={{ maxWidth: "960px", margin: "0 auto" }}>
        ...
        >
          ...
          {" › "}
          <span style={{ color: "#94a3b8" }}>PAN Card Photo Resize</span>
        </nav>
        ...
        <div style={{ marginBottom: "2rem" }}>
          ...
          >
            PAN Card Photo Resize Online Free
          </h1>
          <p style={{ ...bodyText, fontSize: "1.05rem", maxWidth: "760px" }}>
            Resize any photo to the exact NSDL and UTIITSL PAN card application
            specifications — 3.5×2.5 cm (413×295 pixels at 300 DPI), under 50
            KB, JPEG format — instantly in your browser. No uploads to any
            server, no software to install, no account required. Whether you are
            applying for a new PAN card on the NSDL portal, using UTIITSL's
            online facility, submitting a physical Form 49A, or filing a PAN
            correction request, this tool provides the correct preset for every
            submission type.
          </p>
        </div>
        ...
        >
          ...
          >
            <span>🪪</span>
            <span>PAN Card Photo Resizer Tool</span>
          </h2>
          <PhotoResizeTool
            presets={panPresets}
        ...
        {/* ── PAN Card Specifications Reference Table ───────────────── */}
        <div style={cardStyle}>
          <h2 style={h2Style}>
            PAN Card Photo Specifications — Official Reference
          </h2>
          <p style={{ ...bodyText, marginBottom: "1rem" }}>
            The Income Tax Department and its authorised service providers —
            NSDL e-Governance Infrastructure Limited and UTIITSL — have
            published strict photo specifications for PAN card applications. Use
            this table as a quick reference before uploading your photo to any
            PAN portal:
          </p>
          <div
            style={{
          ...
          >
            ...
            >
              ...
              <tbody>
                ...
                ].map(([type, dims, res, size], i) => (
                  <tr
                    key={type}
                    style={{ background: i % 2 === 0 ? "#111827" : "#0f172a" }}
                  >
                    {[type, dims, res, size].map((cell) => (
                      <td
                        key={cell}
                        style={{
                          padding: "0.625rem 0.875rem",
          ...
          >
            * Specifications are based on official NSDL and UTIITSL portal
            documentation. Requirements may be updated — always verify with the
            current portal guidelines at onlineservices.nsdl.com or
            www.utiitsl.com before submission.
          </p>
        </div>
        ...
        <div style={cardStyle}>
          <h2 style={h2Style}>
            How to Resize a PAN Card Photo — Step-by-Step Guide
          </h2>
          <p style={{ ...bodyText, marginBottom: "1.25rem" }}>
            Follow these five steps to resize your photo to NSDL-compliant PAN
            card dimensions in under two minutes using this free browser-based
            tool. No installation, no account, and your photo never leaves your
            device.
          </p>
          <div
        ...
        <div style={cardStyle}>
          <h2 style={h2Style}>PAN Card Photo Requirements — Complete Guide</h2>
          <p style={{ ...bodyText, marginBottom: "1rem" }}>
            The Income Tax Department and its authorised registrars enforce
            strict photo standards for PAN card applications. A non-compliant
            photo is one of the most common reasons for application rejection or
            processing delays at the NSDL and UTIITSL portals. Understanding
            these requirements before you upload saves time and avoids having to
          ...
          <p style={{ ...bodyText, marginBottom: "1rem" }}>
            Both NSDL and UTIITSL require the photo to be in JPEG/JPG format.
            The NSDL portal's standard is 3.5×2.5 cm — at 300 DPI this equals
            413×295 pixels. UTIITSL uses a square format of 200×200 pixels for
            its online portal. For physical Form 49A, the photo must be 3.5×2.5
            cm at a print resolution of 300 DPI. The maximum file size across
            all submission types is 50 KB. This tool's presets automatically
            enforce all dimension and file size constraints for each submission
            method.
          </p>
          ...
          <p style={{ ...bodyText, marginBottom: "1rem" }}>
            The background must be plain white with no patterns, shadows,
            gradients, or objects. Indoor photos against a painted white wall
            work well. Outdoor backgrounds, studio blue or grey backgrounds, and
            any textured surfaces are not acceptable and will result in
            rejection during the application officer's quality review. If your
            photo has a non-white background, use the Background Remover tool
            linked at the bottom of this page to replace it with a white
            background before resizing. Lighting should be even and shadow-free
            — avoid direct flash close to the face, which creates harsh shadows
          ...
          <p style={{ ...bodyText, marginBottom: "1rem" }}>
            The applicant's face must occupy the majority of the photo frame —
            typically at least 70% of the total image area. The face must be
            centred, looking directly at the camera with a neutral expression
            and the mouth closed. Both ears should ideally be visible, and the
            head should not be tilted, turned, or angled. Profile photos and
            photos with the face cut off at the edges are automatically
            rejected. The photo must accurately represent the applicant's
            current appearance and should have been taken within the last six
            months.
          </p>

          <h3 style={{ ...h3Style, marginTop: "1.25rem" }}>
            Prohibited Items — Glasses and Accessories
          </h3>
          <p style={bodyText}>
            Per NSDL and UTIITSL guidelines, spectacles and sunglasses of any
            kind — including prescription glasses — are not permitted in PAN
            card photos. Heavy jewellery that obscures the face outline, such as
            large earrings or a necklace that overlaps the chin, is also not
            acceptable. Head coverings are only permitted for documented
            religious reasons, and in such cases the full face must remain
            clearly visible. The photo must not have any digital filters,
            retouching, or alterations that change the applicant's natural
            appearance.
          </p>
        </div>
        ...
        {/* ── Tips Section ─────────────────────────────────────────── */}
        <div style={cardStyle}>
          <h2 style={h2Style}>Tips for a Successful PAN Card Photo</h2>
          <div
            style={{
              display: "grid",
        ...
        <div style={cardStyle}>
          <h2 style={h2Style}>
            Common PAN Card Photo Mistakes and How to Avoid Them
          </h2>
          <p style={{ ...bodyText, marginBottom: "1.25rem" }}>
            These are the most frequent reasons PAN card photo submissions are
            rejected by NSDL and UTIITSL. Addressing these before you upload
            will save you from having to restart or resubmit your application:
          </p>
          <div
